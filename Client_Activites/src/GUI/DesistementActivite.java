 ...
 * @author Mika
 */
public class DesistementActivite extends javax.swing.JDialog
{
    private String date;
    private String client;
    
    /**
     * Creates new form DesistementActivite
     */
    public DesistementActivite(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
        setTitle("Activité - Désistement");
    }
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(DesistementActivite.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                DesistementActivite dialog = new DesistementActivite(new javax.swing.JFrame(), true);
